...
use crate::{EJR, JSArg, JSArgResult, JSArgType, JSMethod, OpaqueObject, cstr_to_string, derefernce_jsarg, jsarg_as_string, jsarg_bool, jsarg_carray, jsarg_exception, jsarg_list, jsarg_string};

use crate::{exceptions, rust_error_exception};
...
pub fn include_io(ejr: &mut EJR) {
    ...
    let script = include_str!("../../js/io.js");

    ejr.eval_script(&script, "<io>");
}